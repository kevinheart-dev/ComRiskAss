...
const IllnessesTable = () => {
    ...
    useEffect(() => {
        if (Array.isArray(craData.illnesses) && craData.illnesses.length > 0) {
            setCraData((prev) => ({
                ...prev,
                illnesses: craData.illnesses,
            }));
        }
    }, [craData.illnesses, setCraData]);
        ...
        const updated = craData.illnesses.map((item, i) =>
            i === idx
                ? {
                      ...item,
                      [key]:
                          key === "illness" ? value : value.replace(/\D/g, ""),
                  }
                : item,
        );
    ...
    const addIllness = () => {
        ...
        setCraData((prev) => ({
            ...prev,
            illnesses: [...prev.illnesses, newRow],
        }));
